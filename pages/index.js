  ...
  return (
    <Layout>
      ...
      <div className="max-w-5xl mx-auto px-4">
        ...
        <h2 className='text-black text-2xl font-semibold mb-1'>Fitzgerald Lawn Care</h2>
        <p className='text-gray-600 text-base font-normal mb-2'>Lawn care company</p>
        ...
        <div className='flex my-4 gap-3'>
          <button className="w-full justify-center sm:w-72 font-medium  flex rounded-md bg-green-600 text-white items-center p-3 gap-1 text-base" >
        ...
        </svg> Western Wisconsin & Eastern Minnesota</p>
